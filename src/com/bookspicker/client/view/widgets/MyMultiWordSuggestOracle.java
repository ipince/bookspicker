 ...
 * </p>
 */
public class MyMultiWordSuggestOracle extends SuggestOracle {
	 ...
	 */
	private final Trie<String> tree = new Trie<String>();
	 ...
	 */
	public MyMultiWordSuggestOracle(String whitespaceChars) {
	...
	private HashSet<String> createCandidatesFromWord(String query) {
		...
		List<String> words = tree.getData(query, Integer.MAX_VALUE);
		if (words != null) {
