...
public class SchoolClass implements IsSerializable {
    ...
    private String classInfoUrl; // optional
    ...
    public void setClassInfoUrl(String url) {
        this.classInfoUrl = url;
    }
    ...
    public void addBook(Book book, Necessity necessity, Source source, String notes, String url, Boolean hasBook) {
        ClassBook cb = new ClassBook(this, book, necessity, source, notes, url, hasBook);
        if (!books.contains(cb))
            books.add(cb);
    }
